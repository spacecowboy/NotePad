...
import com.nononsenseapps.notepad.android.helpers.TimeFormatter;
...
public class Notification extends DAO {
	...
	public static List<Notification> getNotificationsOfTask(final Context context, final long taskId) {
		return getNotificationsWithTasks(
										...
										new StringBuilder().append(
												com.nononsenseapps.notepad.android.legacydatabase.Notification.Columns.TASKID)
																		+ " IS ?",
										new String[] { Long.toString(taskId) },
										new StringBuilder().append(
												com.nononsenseapps.notepad.android.legacydatabase.Notification.Columns.TIME)
																		.toString());
	}
	...
	public static List<Notification> getNotificationsWithTime(final Context context,
		...
		return getNotificationsWithTasks(
				context,
				new StringBuilder().append(com.nononsenseapps.notepad.android.legacydatabase.Notification.Columns.TIME)
						.append(comparison)
						.append(" AND ")
						.append(com.nononsenseapps.notepad.android.legacydatabase.Notification.Columns.RADIUS)
						.append(" IS NULL")
						.toString(),
			...
			protected Void doInBackground(final Long... ids) {
				...
				final Cursor c = context.getContentResolver()
												.query(Task.URI,
																				...
																				Task.Columns.DBLIST
																												+ " IS ? AND "
																												+ com.nononsenseapps.notepad.android.legacydatabase.Notification.Columns.RADIUS
																												+ " IS NULL",
