...
public class Settings extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SUMMARY_SORT_TYPE = getText(R.string.settings_summary_sort_type_alphabetic).toString();
		
		SUMMARY_SORT_ORDER = getText(R.string.settings_summary_sort_order_desc).toString();
	...
	private void setOrderSummary(SharedPreferences sharedPreferences) {
		...
		if (NotePad.Notes.DEFAULT_SORT_ORDERING.equals(value))
			summary = getText(R.string.settings_summary_sort_order_desc).toString();
		else
			summary = getText(R.string.settings_summary_sort_order_asc).toString();
	...
	private void setTypeSummary(SharedPreferences sharedPreferences) {
		...
		if (NotePad.Notes.DEFAULT_SORT_TYPE.equals(value))
			summary = getText(R.string.settings_summary_sort_type_modified).toString();
		else
			summary = getText(R.string.settings_summary_sort_type_alphabetic).toString();
